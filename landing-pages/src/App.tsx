    ...
    <div class="relative min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <main class="relative z-10 mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10 md:px-10 md:py-14">
        ...
        <section>
          ...
          <div class="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border/70 bg-background/50 px-7 py-7" style="border-bottom-left-radius: 0;border-bottom-right-radius: 0;">
            <div class="inline-flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-sm text-muted-foreground">Приватные заметки для Telegram</p>
              </div>
            </div>
            <a
              href={BOT_WEB_URL}
